...
- Dual fleet profiles: **usual six** `fleet.defaults` (daily) + **heavy eight** `fleet.full`
- Daily Go seats are `glm53=opencode-go/glm-5.3:max` and `hy3=opencode-go/hy3:max` (Go quota 8x); `glm52` / `k27code` / `dots3` dropped
