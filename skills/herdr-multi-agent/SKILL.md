...
Adds back opencode-go `mimopro` and `dsv4flash` (deepseek direct) on top of the six.
...
Phrase map: **usual six = defaults** (legacy: usual nine / eight / seven); **heavy eight = fleet.full** (legacy: usual eleven / ten).
